...
### Features
* OidcStoreProcessSilentSignInCallback returns promise
...
* Fix incorrect type script type for getUser action
...
### Bug fixes
* Fix type error when dispatching getUser if there is no user
...
### Chore
* Change name of removeUser action to removeUser. removeUser is still a synonym
...
### Features
* Implement oidc automatic renewal within pinia.
